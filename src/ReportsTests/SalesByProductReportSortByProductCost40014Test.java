...
public class SalesByProductReportSortByProductCost40014Test {
    ...
    @Test
    public void test40014SalesByProductReportSortByProductCost() throws Exception {
        ...
        String resultSortedTable = js.executeScript("tabl = document.getElementsByClassName('tabulator-cells');filterField = document.getElementsByClassName('base_price').value;let l = []; let w = 0;for (let i = 3; i<tabl.length;i = i + 3){l[w] = tabl[i]; w++;}for(let i =0; i< l.length; i++){let a = l[i].firstChild;if (a != filterField)return false;}return true;").toString();
