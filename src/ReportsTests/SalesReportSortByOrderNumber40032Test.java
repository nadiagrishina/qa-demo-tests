...
public class SalesReportSortByOrderNumber40032Test {
    ...
    @Test
    public void test40021SalesReports() throws Exception {
        ...
        String resultSortedTable = js.executeScript("tabl = document.getElementsByClassName('tabulator-cells');filterField = document.getElementsByClassName('order_number').value;let l = []; let w = 0;for (let i = 1; i<tabl.length;i = i + 9){l[w] = tabl[i]; w++;}for(let i =0; i< l.length; i++){let a = l[i].firstChild;if (a != filterField)return false;}return true;").toString();
