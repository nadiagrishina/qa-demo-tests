...
public class CustomersAddBuyer26031Test {
    ...
    @Test
    public void test26031CustomersBuyer() throws Exception {
        ...
        try {
            assertEquals(CUSTOMER_TAX_NUMBER, driver.findElement(By.id("cosomer-tax-number")).getText());
        } catch (Error e) {
            BufferHelper.appendBuffer(e.toString());
        }
        try {
        ...
        driver.findElement(By.xpath("//nav[@id='nav-list-menu']/div/div[2]/a")).click();
