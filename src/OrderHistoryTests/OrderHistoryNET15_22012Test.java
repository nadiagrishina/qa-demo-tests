...
public class OrderHistoryNET15_22012Test {
    ...
    @Test
    public void test22011OrderHistoryNET15() throws Exception {
        String COMPANY_NAME = "testtest";
        String CUSTOMER_PAYMENTMETHOD = "NET15";
        ...
        driver.findElement(By.id("shipping")).sendKeys(CUSTOMER_PRICE_DELIVERY);
        driver.findElement(By.id("alldiscount_dollars")).clear();
        driver.findElement(By.id("alldiscount_dollars")).sendKeys(ALLDISCOUNT);
