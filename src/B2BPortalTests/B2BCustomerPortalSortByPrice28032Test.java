...
public class B2BCustomerPortalSortByPrice28032Test {
    ...
    @Test
    public void test28032B2BCustomerPortalSortByPrice() throws Exception {
        ...
        String resultSortedTable = js.executeScript("tabl = document.getElementsByClassName('main-product-list');filterField = document.getElementsByClassName('price').value;let l = []; let w = 0;for (let i = 5; i<tabl.length;i = i + 5){l[w] = tabl[i]; w++;}for(let i =0; i< l.length; i++){let a = l[i].firstChild;if (a != filterField)return false;}return true;").toString();
